...
fn main() -> ! {
    ...
    match Task::new()
        ...
        .start(move |_| {
            task_button_check::<PC13<Input<PullUp>>, PA5<Output<PushPull>>, Infallible>(button, semaphore_give);
        })
    {
        Ok(_) => {}
        Err(_) => loop {} 
    ...
    match Task::new()
        ...
        .start(move |_| {
            task_led_blink::<PA5<Output<PushPull>>, Infallible>(led, semaphore_take);
        })
    {
        Ok(_) => {}
        Err(_) => loop {} 
