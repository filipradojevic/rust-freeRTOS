...
#define configCPU_CLOCK_HZ				( 8400000UL ) //also systick runs at this frequency  ovde je bilo 42000000UL
#define configTICK_RATE_HZ				( ( TickType_t ) 1000 ) //1000=1ms per tick, 100=10ms per tick
#define configMAX_PRIORITIES			( 5 )  //ovde je 5 a u c-u 7
#define configMINIMAL_STACK_SIZE		( ( unsigned short ) 80 ) //U c-u je 128 ovde 80
...
#define configQUEUE_REGISTRY_SIZE		5 //U c-u je 8 ovde 5 
...
/* The lowest priority. */
#define configKERNEL_INTERRUPT_PRIORITY 	( configLIBRARY_LOWEST_INTERRUPT_PRIORITY << (8 - configPRIO_BITS) ) //240 je ovo 
/* Priority 5, or 95 as only the top four bits are implemented. */
/* !!!! configMAX_SYSCALL_INTERRUPT_PRIORITY must not be set to zero !!!!
See http://www.FreeRTOS.org/RTOS-Cortex-M3-M4.html. */
#define configMAX_SYSCALL_INTERRUPT_PRIORITY 	( configLIBRARY_MAX_SYSCALL_INTERRUPT_PRIORITY << (8 - configPRIO_BITS) ) //OVO JE 50
